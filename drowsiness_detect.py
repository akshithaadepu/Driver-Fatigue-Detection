...
def main2():
    ...
    while True:
        ...
        grayFrame=cv2.cvtColor(gaara,cv2.COLOR_BGR2GRAY)
        blackAndWhiteFrame=cv2.adaptiveThreshold(grayFrame, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 91, 12)
